...
/// within the MusicXML document should match the musical score order. For example,
/// a note that marks both the end of one slur and the start of a new slur should
/// have the incoming slur element with a type of stop precede the outgoing slur
